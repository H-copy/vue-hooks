 ...
 * @example
 *  
 * const [ userInfo, updateState ] = useStrongeState(localStorage, 'USER_INFO', { nickname: 'coco', age: 24 })
 *  
 * const closeUserInfo = () => updateState()
 * const updateNickname = name => updateState({ ...userInfo.value, nickname: name }) 
 * 
 */
export default function useStrongeState(storage, key, defaultValue){
